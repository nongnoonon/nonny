	    ...
	    <li class="active">Edit Info<span class="divider">/</span></li>
        </ul>
	...
	<?php echo form_open_multipart('backoffice/chkEditInfo', array('id' => 'isForm', 'class' => 'form-horizontal well'), $hidden); ?>
	<?php echo form_fieldset('แก้ไขข่าวสาร'); ?>
	...
	<div class="control-group" id="show_image">
	    ...
	    <div class="controls">
	      <?php echo image_asset("info/thumb/{$row->img_url}", 'control'); ?>
	    </div>
	</div>
	...
	<div class="control-group">
		...
		<?php echo form_hidden('change_image','0'); ?>
	      <?php echo form_upload(array('name'=>'is_files' ,'class'=>'input-xxlarge')); ?>
	      <p class="help-block">ขนาดที่เหมาะสม 248x260 px</p>
	    </div>
	</div>
	<?php endif; ?>
