	    ...
	    <li class="active">Edit Program<span class="divider">/</span></li>
        </ul>
	...
	<?php echo form_open_multipart('backoffice/chkEditProgram', array('id' => 'isForm', 'class' => 'form-horizontal well'), $hidden); ?>
	<?php echo form_fieldset('แก้ไขข้อมูลหลักสูตร'); ?>
