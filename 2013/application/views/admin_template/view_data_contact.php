	...
	<ul class="nav">
	  ...
	  <li><?php echo anchor('backoffice/contact/create', '<i class="icon-book"></i> Create Contact'); ?></li>
	  <li class="divider-vertical"></li>
	...
	$query = $this->db->query("SELECT a.*, b.name_th FROM {$this->db->dbprefix('tab')} a
						  ...
						  WHERE a.type='contact' and b.division='{$this->input->get('group')}'
						");
    ...
    <tbody>
        ...
        <tr>
            ...
            <div class="btn-group">
        	<a class="btn btn-inverse" href="<?php echo $this->Option_model->getURL( 'contact/edit', array('editId'=>$row->id, 'group'=>$this->input->get('group'))); ?>"><i class="icon-cog icon-white"></i> Quick Setting </a>
