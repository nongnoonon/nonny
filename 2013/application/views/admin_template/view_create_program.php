	    ...
	    <li class="active">Create Program<span class="divider">/</span></li>
        </ul>
	...
	<?php echo form_open_multipart('backoffice/chkCreateProgram', array('id' => 'isForm', 'class' => 'form-horizontal well')); ?>
	<?php echo form_fieldset('สร้างข้อมูลหลักสูตร'); ?>
