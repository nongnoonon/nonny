	    ...
	    <li class="active">Create Award<span class="divider">/</span></li>
        </ul>
	...
	<?php echo form_open_multipart('backoffice/chkCreateAward', array('id' => 'isForm', 'class' => 'form-horizontal well'), $hidden); ?>
	<?php echo form_fieldset('สร้างข่าวสารเกี่ยวกับการรับรางวัล'); ?>
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	      ...
	      <p class="help-block">ขนาดของรูปภาพ</p>
	    </div>
	</div>
