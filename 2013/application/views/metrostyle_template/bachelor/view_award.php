		...
		<?php $i++; ?>
			<li class="doublebox"><?php echo anchor($this->Option_model->getURL('award/de/show', array('item'=>$value->id), $this->division), "<i>". image_asset("award/thumb/{$value->img_url}", 'control') ."</i><p>" . substr($value->topic, 0, 30) . "...</p>"); ?></li>
		<?php if($i % 3 == 0): ?>
